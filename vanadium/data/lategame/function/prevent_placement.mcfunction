execute as @a[gamemode=survival,tag=!preventPlacement] run tellraw @s {"text":"You were temporarily set to adventure mode to prevent you from placing a block-based item. Take the item out of your hand to return to suvival mode!","color":"red"}
